  ...
  <nav id="navbar">
    <div class="nav-inner">
      ...
      <div class="nav-actions">
        @auth
          <span class="nav-user">Hola, {{ Auth::user()->nombre }}</span>
    ...
    <div class="mobile-menu" id="mobileMenu">
      ...
      @auth
        <form action="{{ route('logout') }}" method="POST" style="margin:0;">
          @csrf
          <button type="submit" class="btn-primary" style="width:100%;border:none;cursor:pointer;">Cerrar sesión</button>
        </form>
      @else
 ...
 <g id="label_points">
      ...
      <div class="historia-grid" data-reveal>
        ...
        <div class="mvv-cards">
          ...
          <div class="mvv-card highlight" data-reveal>
            <div class="mvv-icon">
              <svg viewBox="0 0 32 32" fill="none"><polygon points="16,2 20,12 31,12 22,19 25,30 16,23 7,30 10,19 1,12 12,12" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/></svg>
            </div>
            <h4>Visión</h4>
          ...
          <div class="mvv-card" data-reveal>
            <div class="mvv-icon">
              <svg viewBox="0 0 32 32" fill="none"><path d="M16 28s-12-7-12-16a8 8 0 0116 0 8 8 0 0116 0c0 9-12 16-12 16z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/></svg>
            </div>
            <h4>Valores</h4>
  ...
  <section class="cta-section section-treasure">
    ...
    <div class="container cta-content" data-reveal>
      ...
      <a href="{{ route('Register') }}" class="btn-primary btn-xl">
        Únete ahora
